...
public class PracticeExam extends HttpServlet // Inheriting from HttpServlet makes this a servlet
{
	...
	public void doGet (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		out.println("<html>");
		out.println("<head>");
		out.println("<title>Practice Exam</title>");
	...
	public void doPost( (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
		...
		String b1 = request.getParameter("book1");
		String b2 = request.getParameter("book2");
		String b3 = request.getParameter("book3");
		...
		out.println("<title>Practice Exam</title>");
                ...
                out.println("<div align='center'>");
                out.println("<h2 align='center' style='font-size: 30px;'>Your Favorite Book Titles:</h2>");
		out.println("<p>Your favorite books are:<br>");
		out.println(output);
		out.println("</p>");
		out.println("</div>");
		out.println("</body>");
